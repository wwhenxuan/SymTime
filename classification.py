...
parser.add_argument('--root_path', type=str, default=f'./datasets/Heartbeat',
...
parser.add_argument('--use_avg', type=bool, default=False, help='use moving average decomposition')
parser.add_argument('--moving_avg', type=int, default=25, help='window size of moving average')
parser.add_argument('--individual', type=bool, default=True, help='whether to forecast the final output individually')
parser.add_argument('--conv1d', type=bool, default=True,
                    help='whether to use 1D convolution to decrease the number of channels')
parser.add_argument('--out_channels', type=int, default=32, help='the target decrease channels')
# model define
