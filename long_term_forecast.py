...
import argparse
import torch
from exp import Exp_Long_Term_Forecast
...
parser.add_argument('--root_path', type=str, default='./datasets/exchange_rate/', help='root path of the data file')
...
# do patching
parser.add_argument('--forward_layers', type=int, default=3, help='the feed forward layers numbers')
...
# metrics (dtw)
parser.add_argument('--use_dtw', type=bool, default=False, help='the controller of using dtw metric')
...
if __name__ == '__main__':
    ...
    setting = '{}_{}_{}_{}_seq_len{}_pred_len{}_moving_avg{}_individual{}_forward_layers{}_patch_len{}_stride{}_batch_size{}_learning_rate{}_lradj{}_seed{}_{}'.format(
        args.task_name,
        args.dataset_name,
        args.model,
        args.data,
