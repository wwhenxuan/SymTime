...
parser.add_argument('--model_id', type=str, default='SWAT', help='model id')
...
parser.add_argument('--root_path', type=str, default='./datasets/SWaT/',
...
parser.add_argument('--anomaly_ratio', type=int, default=0.5)
# do patching
